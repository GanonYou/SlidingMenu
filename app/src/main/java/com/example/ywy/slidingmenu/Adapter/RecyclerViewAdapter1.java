...
public class RecyclerViewAdapter1 extends  RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerViewAdapter1(List<ColumnContent.ColumnItem> items) {
        mValues = items;
    }
...
//        } else {
           ViewHolder mHolder = (ViewHolder) holder;
            ...
            mHolder.mContentView.setText("This is the " + mValues.get(position).content + " ." );
...
//    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mContentView = (TextView) view.findViewById(R.id.tv_info_1);
        }
